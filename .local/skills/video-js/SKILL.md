---
name: video-js
description: Guidelines for creating animated videos in code using React, Framer Motion, and Tailwind CSS.
---

Always follow these guidelines when creating animated videos:

This stack is specifically designed for creating animated videos in code.
Use it to build motion graphics with React, Framer Motion, and Tailwind CSS.
